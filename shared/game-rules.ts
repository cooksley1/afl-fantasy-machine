...
export const AFL_2026_FIXTURES: Record<number, Record<string, { opponent: string; venue: string; time: string }>> = {
  0: {
    "Sydney": { opponent: "Carlton", venue: "SCG", time: "Thu 7:10pm" },
    "Carlton": { opponent: "Sydney", venue: "SCG", time: "Thu 7:10pm" },
    "Gold Coast": { opponent: "Geelong", venue: "People First Stadium", time: "Fri 7:10pm" },
    "Geelong": { opponent: "Gold Coast", venue: "People First Stadium", time: "Fri 7:10pm" },
    "GWS Giants": { opponent: "Hawthorn", venue: "Sydney Showground", time: "Sat 1:10pm" },
    "Hawthorn": { opponent: "GWS Giants", venue: "Sydney Showground", time: "Sat 1:10pm" },
    "Brisbane Lions": { opponent: "Western Bulldogs", venue: "Gabba", time: "Sat 4:35pm" },
    "Western Bulldogs": { opponent: "Brisbane Lions", venue: "Gabba", time: "Sat 4:35pm" },
    "St Kilda": { opponent: "Collingwood", venue: "MCG", time: "Sun 3:20pm" },
    "Collingwood": { opponent: "St Kilda", venue: "MCG", time: "Sun 3:20pm" },
  },
  1: {
