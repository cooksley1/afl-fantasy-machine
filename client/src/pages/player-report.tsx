      ...
      <div className="space-y-4" data-testid="section-performance-charts">
        ...
        <Card>
          <CardContent className="py-8 text-center">
            ...
            <p className="text-sm font-medium">Opening Round — Charts Coming Soon</p>
            <p className="text-xs text-muted-foreground mt-1 max-w-sm mx-auto">
              Performance charts will populate as round scores are recorded. Opening Round scores contribute to player averages and form even though they don't count for AFL Fantasy Classic. Stats below are based on 2025 baseline data and projections.
            </p>
          </CardContent>
        </Card>
      </div>
